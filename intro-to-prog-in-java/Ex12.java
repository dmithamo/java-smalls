 ...
 * value of cos2 + sin2 is approximately 1 for any entered as a command-line
 * argu-
...
class Ex122 {
  public static void main(String[] args) {
    ...
    System.out.println("Math.cos^2(a) + Math.sin^2(a) == 1? " +
                       isApproxOne(angle));
  }

  public static boolean isApproxOne(double angle) {
    double angleInRadians = Math.toRadians(angle);
    double v = Math.pow(Math.cos(angleInRadians), 2) +
               Math.pow(Math.sin(angleInRadians), 2);
 ...
 * d. System.out.println(-2-a); # max -ve minus 2 -> wraps around to max +ve -1
 * [-1-1-a]
 *
 * e. System.out.println(2*a); # This one I had to Gemini/Google. Needs
 * re-reading
 *
...
class Ex1218 {
  public static void main(String[] args) {
    if (args.length < 2) {
      ...
      System.out.println(
          "Euclidian distance to (" + x + ", " + y + ") from (0, 0): " +
...
class Ex1219 {
  public static void main(String[] args) {
    if (args.length < 2) {
      ...
      System.out.println(
          "Random number in the range [" + lower + ", " + upper +
          "] (incl.): " + (int)((Math.random() * (upper - lower)) + lower));
    }
  }
}
